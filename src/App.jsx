  ...
  return (
    <>
      ...
      <section className="product py-[30px] px-0 bg-grid-black/[0.2] "> 
        <h1 className="text-6xl text-black font-bold font-sans pb-10 flex justify-center" >Product Catalog</h1>
        <div className="container w-[100%] mr-auto ml-auto pl-[15px] pr-[15px] sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px]">
          ...
          <div className="flex justify-between items-center mb-10">
            <form className="form relative w-[45%] pl-[5px] block transition-all duration-500 ease-linear hover:w-[50%] max-lg:w-[70%] max-lg:hover:w-[75%] max-md:w-[70%] max-md:hover:w-[75%]">
            ...
            <div className="w-[45%] text-right">
              <select
                className="sorting-dropdown px-2 py-2 border rounded-lg shadow-lg shadow-black"
                value={sortOption}
